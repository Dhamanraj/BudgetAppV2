DROP PROCEDURE IF EXISTS BudgetApp.`SP_RAW_LOAD_CITI_TRANSACTIONS`;

CREATE OR REPLACE PROCEDURE BudgetApp.`SP_RAW_LOAD_CITI_TRANSACTIONS`(
...
BEGIN
    ...
    VALUES ('SP_RAW_LOAD_CITI_TRANSACTIONS', varBankId, 'STARTED');
